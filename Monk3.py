...
plt.savefig(f"grafici/monk3_batch{batch_size}_learningrate{opt_config['learning_rate']}_reg_{reg_config['reg_type']}_lambda{reg_config['Lambda']}_opt_{opt_config['opt_type']}.pdf", bbox_inches = 'tight', dpi = 1200)
