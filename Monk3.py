...
plt.savefig("grafici_per_slides/Monk3_error_reg.pdf", bbox_inches = 'tight', dpi = 1200)
...
plt.savefig("grafici_per_slides/Monk3_accuracy_reg.pdf", bbox_inches = 'tight', dpi = 1200)
